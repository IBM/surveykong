# Generated by Django 3.2.5 on 2021-10-12 20:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feed_to_lux', models.BooleanField(default=True)),
                ('trigger_type', models.CharField(blank=True, choices=[('intercept', 'Intercept'), ('button', 'Button')], default='', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('checkbox', 'Checkboxes'), ('date', 'Date'), ('email', 'Email'), ('message', 'Message'), ('number', 'Number'), ('radio', 'Radio buttons'), ('select', 'Select list'), ('selectmultiple', 'Select multiple'), ('textinput', 'Text input'), ('textarea', 'Textarea'), ('url', 'URL')], default='text', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('feedback_form', models.BooleanField(default=False)),
                ('feedback_default', models.BooleanField(default=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=survey.models.getToday)),
