...
urlpatterns = [
	...
	url(r'^config/(?P<uid>[\w-]+).js$', project_config_javascript, name='project_config_javascript'),
	...
	url(r'^api/removecampiagnuserinfo/$', api_remove_campaign_user_info, name='api_remove_campaign_user_info'),
